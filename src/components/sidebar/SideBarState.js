...
import { sideBarItemsMap } from './SideBarItems.js'
import { useCallback, useEffect, useState } from 'react'
import { USER_MENU_LINKS } from '../../services/queries.js'
...
const useSideBarState = () => {
  ...
  useQuery(USER_MENU_LINKS, {
    ...
    onError: (error) => standardApolloError('USER_MENU_LINKS', error, translate),
  })
