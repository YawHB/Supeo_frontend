                ...
                <Col xs="auto" style={{ minWidth: '130px', maxWidth: '270px' }}>
                    <SideBar
                        ...
                        toggleSideBarCollapse={
                            sideBarState.toggleSideBarCollapse
                        }
                    />
                </Col>
                    ...
                    >
                        ...
                        <div className="d-flex align-items-center gap-4">
                            ...
                            >
                                ...
                                />
                                <span>
                                    {translate(`admin.create_employee`)}
                                </span>
                            </Button>
                        </div>
                    </Col>
                    ...
                    {!state.isLoadingEmployees && (
                        <Table striped bordered hover responsive>
                            <thead className="table-light">
                                <tr>
                                    {state.employeesTableColumns.map(
                                        (column) => (
                                            <th key={column.key}>
                                                {column.label}
                                            </th>
            ...
            >
                ...
                <ModalFooter>
                    <Button
                        ...
                        disabled={
                            state.isSubmittingNewEmployee ||
                            state.isUpdatingEmployee
                        }
                    >
                        {translate('create')}
                    </Button>
